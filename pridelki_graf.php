...
// podatki za graf o zaslužku za posamezno vrsto
$stmt = mysqli_prepare($conn, "SELECT vrsta as oznaka, kolicina_prodanega_pridelka * cena as kolicina FROM pridelek");
mysqli_stmt_execute($stmt);
...
<div class="container-fluid" data-aos="fade-up">
  ...
  <div class="container mt-4 text-center">
      <button id="prikaz1" class="btn btn-primary mt-1">Prikaži prodanost pridelkov</button>
      <button id="prikaz2" class="btn btn-primary mt-1">Prikaži zaslužek pridelkov</button>
  </div>
...
<script>
    ...
    var oznaka1 = 'Količina pridelanega vina';
    createPieChart(pod1);
    ...
    oznaka1 = 'Količina pridelanega vina';
    createPieChart(pod1);
    });

...
// podatki za graf o številu trt na velikost zemljišča
$stmt = mysqli_prepare($conn, "SELECT ID as oznaka, velikost / kolicina_trt as kolicina FROM zemljisce");
...
// podatki za graf o zaslužku na zemljišče
$stmt = mysqli_prepare($conn, "SELECT z.ID as oznaka, SUM(kolicina_prodanega_pridelka * cena) as kolicina FROM pridelek p INNER JOIN zemljisce z ON z.ID = p.zemljisce_ID GROUP BY z.ID");
mysqli_stmt_execute($stmt);
...
<div class="container-fluid" data-aos="fade-up">
  ...
  <div class="container mt-4 text-center">
      <button id="prikaz1" class="btn btn-primary mt-1">Prikaži razmerje med številom trt in velikostjo zemljišča</button>
      <button id="prikaz2" class="btn btn-primary mt-1">Prikaži zaslužek na zemljišče</button>
  </div>
...
<script>
    ...
    var oznaka1 = 'Število trt na velikost zemljišča';
    createPieChart(pod1);
    ...
    oznaka1 = 'Zaslužek na zemljišče';
    createPieChart(pod2);
    });

    document.getElementById("nazaj").onclick = function () {
      location.href = "zemljisca.php";
    };
</script>
</body>
</html>
